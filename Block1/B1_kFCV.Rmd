...
* For detailed discussion of the `kFCV` topic, see e.g. [James et. al: Introduction to Statistical Learning with Applications in R](https://www-bcf.usc.edu/~gareth/ISL/) , chapter 5 (5.1)
